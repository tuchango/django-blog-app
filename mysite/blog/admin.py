...
class PostAdmin(admin.ModelAdmin):
    list_display = ['title', 'author', 'published', 'status']  # добавить столбцы таблицы
    list_filter = ['published', 'author', 'status']  # справа появится меню с фильтрами
    ...
    date_hierarchy = 'published'  # можно над таблицей выбирать дату
